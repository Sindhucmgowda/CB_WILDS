...
if __name__ == "__main__":
    ...
    parser.add_argument('--logging-dir','-l', type=str, default='/scratch/gobi2/sindhu/cb/synthetic/debug',required=False)
    ...
    path = os.path.join(args.logging_dir,f'fin_res_{args.test_corr}.p')
